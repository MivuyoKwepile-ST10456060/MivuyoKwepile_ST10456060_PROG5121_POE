...
public class LoginTest {
    ...
    public void testValidUsername() {
        Login login = new Login("user_", "Password1!", "0123456789");
        assertTrue(login.checkUsername("user_"));
    }

    @Test
    public void testInvalidUsername_NoUnderscore() {
        Login login = new Login("user", "Password1!", "0123456789");
        assertFalse(login.checkUsername("user"));
    }

    @Test
    public void testInvalidUsername_TooLong() {
        Login login = new Login("user_long", "Password1!", "0123456789");
    ...
    public void testInvalidPassword_NoNumber() {
        Login login = new Login("user_", "Password!", "0123456789");
    ...
    public void testRegisterUser_InvalidPassword() {
        Login login = new Login("user_", "pass", "0123456789");
    ...
    public void testLoginUser_Success() {
        Login registeredUser = new Login("user_", "Password1!", "0123456789");
